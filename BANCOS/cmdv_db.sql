...
--
-- Host: localhost
-- Tempo de geração: 06/08/2020 às 20:07
...
INSERT INTO `categorias` (`cat_codigo`, `cat_descricao`, `ID_CPF_EMPRESA`) VALUES
(1, 'doces / balas', '22124254812'),
(2, 'bebidas / refrigerantes / sucos', '22124254812'),
(3, 'salgadinhos', '22124254812'),
(4, 'biscoitos', '22124254812'),
(5, 'bebida alcolica', '22124254812'),
(6, 'refri lata', '22124254812'),
(7, 'condimentos', '22124254812'),
(8, 'frios', '22124254812'),
(9, 'laticinios', '22124254812'),
(10, 'produtos limpesa', '22124254812'),
(11, 'categoria de produtos novos', '22124254812'),
(12, 'bebidas', '17984958050'),
(13, 'alimentos', '03100188462'),
(14, 'decartaveis', '03100188462'),
(15, 'limpesa', '03100188462');

-- --------------------------------------------------------

--
-- Estrutura para tabela `chave_de_licenca`
--

CREATE TABLE `chave_de_licenca` (
  `lic_id` int NOT NULL,
  `lic_chave` varchar(50) NOT NULL,
  `lic_dias` int NOT NULL,
...
--
-- Despejando dados para a tabela `chave_de_licenca`
--

INSERT INTO `chave_de_licenca` (`lic_id`, `lic_chave`, `lic_dias`, `lic_usada_por`, `lic_datahora_uso`, `lic_status`) VALUES
(10, '221242', 60, '', '2017-09-10 03:06:39', 'N'),
(11, '4601704784', 100, 'LICENCA USADA POR :: 16994323453 - usuario@gmail.com - cmdv-produtos-ldtda', '2020-07-17 20:09:52', 'S');
...
CREATE TABLE `cheques` (
  ...
  `chq_codigo` int NOT NULL,
  `chq_cli_codigo` int DEFAULT NULL,
...
INSERT INTO `cheques` (`ID_CPF_EMPRESA`, `chq_codigo`, `chq_cli_codigo`, `chq_numerocheque`, `chq_telefone1`, `chq_telefone2`, `chq_cpf_dono`, `chq_nomedono`, `chq_nomebanco`, `chq_vencimento`, `chq_valorcheque`, `chq_terceiro`, `vendac_chave`, `chq_dataCadastro`, `chq_enviado`) VALUES
('22124254812', 1, 2, '3423', '(11)1-0247-8568', '(41)6-1616-8756', '22124254812', 'distribuidora de bebidas martins ltda', 'banco do brasil', '2017-09-18', '500.00', 'N', '2472445', '2017-09-16', 'N');
...
INSERT INTO `cidades` (`ID_CPF_EMPRESA`, `cid_codigo`, `cid_nome`, `cid_uf`) VALUES
...
INSERT INTO `clientes` (`ID_CPF_EMPRESA`, `cli_codigo`, `cli_nome`, `cli_fantasia`, `cli_endereco`, `cli_bairro`, `cli_cep`, `cid_codigo`, `cli_contato1`, `cli_contato2`, `cli_contato3`, `cli_nascimento`, `cli_cpfcnpj`, `cli_rginscricaoest`, `cli_limite`, `cli_email`, `cli_observacao`, `usu_codigo`, `cli_senha`, `cli_chave`) VALUES
('17984958050', 1, 'gilberto gomes dos santos', 'serv gelo ltda', 'rua santos dumont 1659', 'sambra', '14600-000', 3500501, '(11)1-1111-1111', '(41)6-1616-1616', '(16)0123-1616', '2017-05-15', '22124254812', '545465465456', '300.00', 'centralmetadevendas@gmail.com', 'null', 42, '123456', ''),
('17984958050', 2, 'fernando henrique dos santos matrins', 'distribuidora de bebidas martins ltda', 'rua frei henrique 45', 'centro', '14600-000', 3500501, '(11)1-0247-8568', '(41)6-1616-8756', '(16)3811-8652', '2017-05-15', '22124254812', '545465465456', '300.00', 'centralmetadevendas@gmail.com', 'null', 42, '123456', ''),
('17984958050', 3, 'irmão santo antonio', 'emporio e distribuição ltda', 'rua padre anchieta 1000', 'residencial espigão', '14800-000', 3500501, '(11)1-3728-1111', '(41)6-1616-0021', '(16)3728-5689', '2017-05-15', '22124254812', '545465465456', '300.00', 'centralmetadevendas@gmail.com', 'null', 3, '123456', ''),
('17984958050', 4, 'tancredão materiais para contrução', 'tancredão empreendimentos ', 'rua xv de novembro 23658', 'jdm luciana', '15369-000', 3500501, '(11)1-3728-0255', '(41)6-1616-2541', '(16)1616-1616', '2017-05-15', '22124254812', '545465465456', '300.00', 'centralmetadevendas@gmail.com', 'null', 3, '123456', ''),
('17984958050', 5, 'carlos alberto medeiros', 'medeiros distribuidora de produtos', 'avenida campos eliseos 25869', 'lapa', '14600-000', 3500501, '(11)1-3685-0214', '(41)6-3811-1616', '(16)9578-1616', '2017-05-15', '22124254812', '545465465456', '300.00', 'centralmetadevendas@gmail.com', 'null', 3, '123456', ''),
('', 6, '', '', '', '', '', 0, '', '', '', '0000-00-00', '', '', '0.00', '', '', 0, '', ''),
('17984958050', 7, 'junco industria', 'nome fantasia', 'endereco de araras', 'araraquara', '23423-234', 3503208, '(23)4-2342-3423', '(32)4-3242-3423', '(42)3423-4234', '1999-09-15', '232312312213', '21321321312', '1000.00', 'araraquara@gmail.com', 'araraquara', 0, 'araraquara', ''),
('17984958050', 8, 'jose da silva', 'ze do me', 'rua general moura, 25', 'centro', '65765435', 0, '(16)9-9999-0101', '(16)9-9999-0101', '(16)3811-0101', '1978-09-18', '35519909000135', '64948521', '500.00', 'jose@gmai.com', 'cliente-cadastrado-no-android', 44, '123456', ''),
('03100188462', 9, 'casas oliveiras ltda', 'oliveira', 'rua d', 'centro', '99999-999', 1200013, '(71)8-2636-3636', '(71)8-6448-4848', '(71)8484-9494', '1980-09-14', '00000000000191', 'isento', '1000.00', 'oliveira@gmail.com', '', 0, '12345', ''),
('03100188462', 10, 'supranor ltda', 'casa do criador', 'av pres vargas', 'lapa', '45000-000', 1600204, '(35)3-5353-5335', '(79)7-9879-7797', '(77)7977-9797', '2002-02-14', '60.746.948/0001-12', '3232323', '5000.00', 'supranor@hotmail.com', '', 46, '12345', ''),
('03100188462', 11, 'joao severino da silva', 'joao do gato', 'travessa 5', 'amarelina', '44444-444', 2900108, '(45)4-5433-6436', '(46)3-4643-6364', '(64)3634-6636', '1970-08-22', '031.001.884-62', '3.465.747', '500.00', 'joao@ig.com', '', 0, '12345', '');

-- --------------------------------------------------------

--
-- Estrutura para tabela `conf_pagamento`
--
...
CREATE TABLE `conf_pagamento` (
  ...
  `pag_parcelas_cartao` int NOT NULL,
  `pag_parcelas_normal` int NOT NULL,
...
--
-- Despejando dados para a tabela `conf_pagamento`
--

INSERT INTO `conf_pagamento` (`pag_id`, `ID_CPF_EMPRESA`, `vendac_chave`, `pag_parcelas_cartao`, `pag_parcelas_normal`, `pag_valor_recebido`, `pag_recebeucom_din_chq_cart`, `pag_tipo_pagamento`, `pag_sementrada_comentrada`) VALUES
(2, '22124254812', '2104459', 0, 0, '855.50', 'DINHEIRO', 'AVISTA', 'false'),
(3, '22124254812', '2472445', 0, 0, '555.50', 'CHEQUE', 'AVISTA', 'false'),
(4, '22124254812', '8519386', 0, 7, '0.00', '', 'MENSAL', 'false'),
(5, '22124254812', '8884385', 2, 0, '72.00', 'CARTAO', 'AVISTA', 'false'),
(6, '03100188462', '1020782', 0, 0, '16.50', 'DINHEIRO', 'AVISTA', 'false'),
(7, '03100188462', '8586673', 0, 0, '8.00', 'DINHEIRO', 'AVISTA', 'false'),
(8, '03100188462', '4475958', 0, 0, '6.00', 'DINHEIRO', 'AVISTA', 'false'),
(9, '03100188462', '3861402', 0, 1, '0.00', '', 'MENSAL', 'false'),
(10, '03100188462', '3462501', 2, 0, '150.00', 'CARTAO', 'AVISTA', 'false'),
(11, '03100188462', '4178816', 0, 2, '0.00', '', 'QUINZENAL', 'false');
...
CREATE TABLE `empresa` (
  ...
  `emp_nome` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `emp_cpf` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `emp_licenca` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `emp_inicio` date DEFAULT NULL,
  `emp_fim` date NOT NULL,
  `emp_celularkey` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `usu_codigo` int NOT NULL,
  `emp_datapedido` date NOT NULL,
  `emp_totalemdias` int NOT NULL,
  `emp_numerocelular` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `emp_email` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `empresa` (`emp_codigo`, `emp_nome`, `emp_cpf`, `emp_licenca`, `emp_inicio`, `emp_fim`, `emp_celularkey`, `usu_codigo`, `emp_datapedido`, `emp_totalemdias`, `emp_numerocelular`, `emp_email`) VALUES
(45, 'supranol ltda', '03100188462', '696000774', '2020-08-05', '2020-09-28', 'db13c31d4e764e0f', 0, '2020-07-18', 60, '81988029779', 'augustoall@gmail.com'),
(46, 'diretor', '22124254812', '696000774', '2020-08-05', '3000-07-28', '3fxDIRETOR', 0, '0000-00-00', 25577, '16991431147', 'diretor@gmail.com'),
(47, 'supranol', '03100188462', '107017128a', '2020-08-05', '2020-07-28', '7ed06244a9e3797f', 0, '2020-07-18', 10, '16991431147', 'vendedor001@gmail.com');
...
INSERT INTO `entrada_produtos` (`ID_CPF_EMPRESA`, `ent_id`, `ent_numeronota`, `ent_data_entrada`, `ent_valor_nota`, `usu_codigo`, `for_codigo`) VALUES
('03100188462', 1, 12345, '2020-07-18 10:07:46', '200.00', 45, 2),
('03100188462', 2, 123, '2020-07-18 10:07:44', '200.00', 45, 2),
('03100188462', 3, 12, '2020-07-18 10:07:27', '500.00', 45, 2),
('22124254812', 4, 2345, '2020-07-18 11:07:49', '12000.00', 42, 1),
('22124254812', 5, 2323432, '2020-07-18 11:07:34', '123.33', 42, 1),
('03100188462', 6, 2123, '2020-07-18 13:07:08', '32.32', 45, 2),
('03100188462', 7, 45, '2020-07-20 10:07:30', '500.00', 45, 2),
('03100188462', 8, 76, '2020-07-20 10:07:51', '4000.00', 45, 2),
('03100188462', 9, 543, '2020-07-20 12:07:06', '1000.00', 45, 2);

-- --------------------------------------------------------

--
-- Estrutura para tabela `entrada_produtos_d`
--
...
--
-- Despejando dados para a tabela `entrada_produtos_d`
--

INSERT INTO `entrada_produtos_d` (`ID_CPF_EMPRESA`, `ent_id`, `entd_ean`, `entd_prd_codigo`, `entd_descricaoprd`, `entd_custo`, `entd_qtd`, `entd_margem`, `entd_preco`) VALUES
('03100188462', 1, '43434344', 99, 'cocada amarela', '1.00', '200.00', '0.00', '2.00'),
('03100188462', 2, '5598979862546', 80, 'suco tampico 250ml', '1.00', '200.00', '0.00', '2.00'),
('03100188462', 3, '43434344', 99, 'cocada amarela', '5.00', '100.00', '0.00', '12.00'),
('03100188462', 6, '5555698978978', 82, 'pacoquinha moreninha do rio', '4.00', '100.00', '0.00', '10.00'),
('03100188462', 7, '1234567890', 99, 'cocada amarela', '100.00', '5.00', '0.00', '300.00'),
('03100188462', 8, '1234567890908', 99, 'cocada amarela', '100.00', '4.00', '0.00', '500.00'),
('03100188462', 9, '1234567890908', 99, 'cocada amarela', '100.00', '10.00', '0.00', '200.00');

-- --------------------------------------------------------

--
-- Estrutura para tabela `firebase_devices`
--

CREATE TABLE `firebase_devices` (
  `id` int NOT NULL,
  `ID_CPF_EMPRESA` varchar(11) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `registration_id` varchar(300) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `emp_celularkey` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;

--
-- Despejando dados para a tabela `firebase_devices`
--

INSERT INTO `firebase_devices` (`id`, `ID_CPF_EMPRESA`, `registration_id`, `emp_celularkey`) VALUES
(45, '22124254812', 'dFjw4JFx1VA:APA91bEs8DunSPoEs5zGUWr7GMOkzyIV494COtO-rKX6efOJbARWES1bobwIzVUmgf7UzwpHRHZVYN2TR6jvzVb4MRuyCLf2EgKA6yvNO8hmaCxWavOBzmRaCMRYm86rqHJStCxfcUj8', '37166947d991af9b');
...
INSERT INTO `fornecedores` (`ID_CPF_EMPRESA`, `for_codigo`, `for_razaosocial`, `for_fantasia`, `for_endereco`, `for_cep`, `for_bairro`, `for_contato1`, `for_contato2`, `for_representante`, `for_email`, `for_cnpjcpf`, `cid_codigo`) VALUES
('22124254812', 1, 'distribuidota de bebidas ', 'distribuidora de alimentos ltda', 'avenida industrial 500', '15666-698', 'industrial', '4564654', '89798798', 'pedro', 'ltada@gmail.com', '22124254812', 2000),
('03100188462', 2, 'unilever ltda', 'unilever', 'av 4 agosto', '10000-000', 'metropole', '(53)-5553-5335', '(86)-5-8868-6868', 'assis', 'unilever@gmail.com', '61.068.276/0001-04', 3506003);
...
CREATE TABLE `historico_pagamento` (
  ...
  `hist_numero_parcela` int DEFAULT NULL,
...
INSERT INTO `historico_pagamento` (`ID_CPF_EMPRESA`, `hist_codigo`, `hist_numero_parcela`, `hist_valor_real_parcela`, `hist_valor_pago_no_dia`, `hist_restante_a_pagar`, `hist_datapagamento`, `hist_nomecliente`, `hist_pagou_com`, `vendac_chave`, `hist_enviado`, `usu_celularkey`) VALUES
('22124254812', 4, 1, '855.50', '855.50', '0.00', '2017-09-16', 'gilberto gomes dos santos', 'DINHEIRO', '2104459', 'N', '37166947d991af9b'),
('22124254812', 5, 1, '555.50', '555.50', '0.00', '2017-09-16', 'fernando henrique dos santos matrins', 'CHEQUE', '2472445', 'N', '37166947d991af9b'),
('22124254812', 6, 1, '72.00', '72.00', '0.00', '2020-07-17', 'gilberto gomes dos santos', 'CARTAO', '8884385', 'N', '7ed06244a9e3797f'),
('03100188462', 7, 1, '16.50', '16.50', '0.00', '2020-07-18', 'casas oliveiras ltda', 'DINHEIRO', '1020782', 'N', '7ed06244a9e3797f'),
('03100188462', 17, 1, '8.00', '8.00', '0.00', '2020-07-18', 'casas oliveiras ltda', 'DINHEIRO', '8586673', 'N', 'db13c31d4e764e0f'),
('03100188462', 18, 1, '6.00', '6.00', '0.00', '2020-07-18', 'supranor ltda', 'DINHEIRO', '4475958', 'N', 'db13c31d4e764e0f'),
('03100188462', 19, 1, '17.00', '17.00', '0.00', '2020-07-18', 'supranor ltda', 'DINHEIRO', '3861402', 'N', 'db13c31d4e764e0f'),
('03100188462', 20, 1, '150.00', '150.00', '0.00', '2020-07-18', 'joao severino da silva', 'CARTAO', '3462501', 'N', 'db13c31d4e764e0f'),
('03100188462', 21, 1, '413.00', '413.00', '0.00', '2020-07-18', 'casas oliveiras ltda', 'DINHEIRO', '4178816', 'N', 'db13c31d4e764e0f');

-- --------------------------------------------------------

--
-- Estrutura para tabela `imagensprd`
--
...
INSERT INTO `log` (`log_id`, `ID_CPF_EMPRESA`, `log_celular_usuario`, `log_codigo_usuario`, `log_email_usuario`, `log_datahora_ocorrencia`, `log_tabela`, `log_acao`) VALUES
(203, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-07-17 16:21:06', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(204, '17984958050', '16994323453', '43', 'usuario@gmail.com', '2020-07-17 16:58:38', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(205, '17984958050', '16994323453', '43', 'usuario@gmail.com', '2020-07-17 16:59:03', 'CATEGORIAS', 'GRAVAR->> bebidas  /  NIVEL->> ADM'),
(206, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-07-17 17:01:18', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(207, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-07-17 17:03:26', 'LICENCA', 'GRAVAR LICENCA   /  NIVEL->> DIRETOR'),
(208, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-07-17 17:09:48', 'EMPRESA', 'ALTERAR DATA->> 2030-07-27  /  NIVEL->> DIRETOR'),
(209, '17984958050', '16994323453', '43', 'usuario@gmail.com', '2020-07-17 18:42:04', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(210, '17984958050', '16994323453', '43', 'usuario@gmail.com', '2020-07-17 19:21:26', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(211, '17984958050', '16994323453', '43', 'usuario@gmail.com', '2020-07-17 19:41:40', 'CLIENTES', 'GRAVAR->> junco industria  /  NIVEL->> ADM'),
(212, '17984958050', '16994323453', '43', 'usuario@gmail.com', '2020-07-17 20:01:06', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(213, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-07-17 20:39:18', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(214, '17984958050', '16994323453', '43', 'usuario@gmail.com', '2020-07-18 08:21:10', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(215, '17984958050', '16994323453', '43', 'usuario@gmail.com', '2020-07-18 08:54:51', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(216, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 09:22:39', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(217, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 09:23:37', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(218, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 09:28:13', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(219, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 09:28:26', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(220, '03100188462', '16991431147', '46', 'vendedor001@gmail.com', '2020-07-18 09:39:11', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(221, '03100188462', '16991431147', '46', 'vendedor001@gmail.com', '2020-07-18 09:42:24', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(222, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 10:12:26', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(223, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 10:18:49', 'CLIENTES', 'GRAVAR->> CASAS OLIVEIRAS LTDA  /  NIVEL->> ADM'),
(224, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 10:23:46', 'CLIENTES', 'GRAVAR->> SUPRANOR LTDA  /  NIVEL->> ADM'),
(225, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 10:26:27', 'CLIENTES', 'GRAVAR->> joão severino da silva  /  NIVEL->> ADM'),
(226, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 10:29:09', 'FORNECEDOR', 'GRAVAR->> UNILEVER LTDA  /  NIVEL->> ADM'),
(227, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 10:29:49', 'CATEGORIAS', 'GRAVAR->> ALIMENTOS  /  NIVEL->> ADM'),
(228, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 10:30:00', 'CATEGORIAS', 'GRAVAR->> DECARTAVEIS  /  NIVEL->> ADM'),
(229, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 10:30:50', 'CATEGORIAS', 'GRAVAR->> LIMPESA  /  NIVEL->> ADM'),
(230, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 10:31:52', 'PRODUTOS', 'GRAVAR->> cocada amarela  /  NIVEL->> ADM'),
(231, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 10:36:01', 'PRODUTOS', 'IMPRESSAO DE RELATORIO DE PRODUTOS  /  NIVEL->> ADM'),
(232, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 10:42:45', 'PRODUTOS', 'ALTERAR->> cocada amarela  /  NIVEL->> ADM'),
(233, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 10:43:55', 'PRODUTOS', 'IMPRESSAO DE RELATORIO DE PRODUTOS  /  NIVEL->> ADM'),
(234, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 10:45:08', 'PRODUTOS', 'IMPRESSAO DE RELATORIO DE PRODUTOS  /  NIVEL->> ADM'),
(235, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-07-18 10:45:10', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(236, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 10:46:13', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(237, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-07-18 10:47:48', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(238, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-07-18 10:48:36', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(239, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-07-18 10:51:42', 'EMPRESA', 'ALTERAR DATA->> 3000-07-28  /  NIVEL->> DIRETOR'),
(240, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-07-18 10:52:50', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(241, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 10:53:09', 'PRODUTOS', 'ALTERAR->> cocada amarela  /  NIVEL->> ADM'),
(242, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 11:04:06', 'CLIENTES', 'IMPRESSAO DE RELATORIO CLIENTE  /  NIVEL->> ADM'),
(243, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-07-18 11:04:18', 'PRODUTOS', 'GRAVAR->> biscoito pampers  /  NIVEL->> DIRETOR'),
(244, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 11:51:44', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(245, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-07-18 12:52:13', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(246, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 12:59:11', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(247, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 13:06:00', 'PRODUTOS', 'IMPRESSAO DE RELATORIO DE PRODUTOS  /  NIVEL->> ADM'),
(248, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-18 13:46:01', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(249, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-20 09:14:28', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(250, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-20 10:55:38', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(251, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-20 10:58:16', 'PRODUTOS', 'IMPRESSAO DE RELATORIO DE PRODUTOS  /  NIVEL->> ADM'),
(252, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-20 10:59:35', 'PRODUTOS', 'ALTERAR->> cocada amarela  /  NIVEL->> ADM'),
(253, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-20 12:57:14', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(254, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-07-20 12:57:23', 'PRODUTOS', 'IMPRESSAO DE RELATORIO DE PRODUTOS  /  NIVEL->> ADM'),
(255, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-08-05 11:15:53', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(256, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-08-05 11:16:42', 'EMPRESA', 'ALTERAR DATA->> 2020-08-28  /  NIVEL->> DIRETOR'),
(257, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-08-05 11:18:06', 'EMPRESA', 'ALTERAR DATA->> 2020-07-28  /  NIVEL->> DIRETOR'),
(258, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-08-05 11:18:25', 'EMPRESA', 'ALTERAR DATA->> 2020-07-28  /  NIVEL->> DIRETOR'),
(259, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-08-05 11:19:13', 'EMPRESA', 'ALTERAR DATA->> 2020-07-28  /  NIVEL->> DIRETOR'),
(260, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-08-05 11:29:21', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(261, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-08-05 11:31:06', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(262, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-08-05 11:54:56', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(263, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-08-05 11:58:23', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(264, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-08-05 17:13:31', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(265, '03100188462', '81988029779', '45', 'augustoall@gmail.com', '2020-08-05 17:17:27', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(266, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-08-05 17:19:05', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA'),
(267, '22124254812', '16993584313', '42', 'diretor@gmail.com', '2020-08-05 17:20:23', 'LOGIN NO SISTEMA', 'LOGIN NO SISTEMA');
...
INSERT INTO `logomarcas` (`ID_CPF_EMPRESA`, `lgm_codigo`, `lgm_nomelogo`) VALUES
('03100188462', 1, 'LogoTeste.png');
...
INSERT INTO `permissoes` (`ID_CPF_EMPRESA`, `per_codigo`, `nome_tabela`, `log_numerocelular`, `usu_celularkey`, `per_incluir`, `per_alterar`, `per_visualizar`, `per_excluir`, `per_nivel`) VALUES
('22124254812', 961, 'TABELAS', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 962, 'CATEGORIAS', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 963, 'CHAVE_DE_LICENCA', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 964, 'CHEQUES', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 965, 'CIDADES', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 966, 'CLIENTES', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 967, 'CONF_PAGAMENTO', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 968, 'EMPRESA', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 969, 'EMPRESA_CONFIG', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 970, 'ENTRADA_PRODUTOS', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 971, 'ENTRADA_PRODUTOS_D', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 972, 'FIREBASE_DEVICES', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 973, 'FORNECEDORES', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 974, 'HISTORICO_PAGAMENTO', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 975, 'IMAGENSPRD', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 976, 'LOG', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 977, 'LOGOMARCAS', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 978, 'PERMISSOES', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 979, 'PRODUTOS', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 980, 'RECEBER', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 981, 'USUARIOS', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 982, 'USUARIOS_LOGIN_TENTA', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 983, 'VENDAC', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 984, 'VENDAD', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 985, 'USUARIOS_LOGIN_TENTA', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 986, 'USUARIOS_LOGIN_TENTA', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 987, 'USUARIOS_LOGIN_TENTA', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 988, 'USUARIOS_LOGIN_TENTA', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 989, 'USUARIOS_LOGIN_TENTA', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 990, 'USUARIOS_LOGIN_TENTA', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('22124254812', 991, 'USUARIOS_LOGIN_TENTA', '16993584313', '3fxDIRETOR', 'S', 'S', 'S', 'N', 'DIRETOR'),
('03100188462', 1077, 'TABELAS', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1078, 'CATEGORIAS', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1079, 'CHAVE_DE_LICENCA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1080, 'CHEQUES', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1081, 'CIDADES', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1082, 'CLIENTES', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1083, 'CONF_PAGAMENTO', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1084, 'EMPRESA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1085, 'EMPRESA_CONFIG', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1086, 'ENTRADA_PRODUTOS', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1087, 'ENTRADA_PRODUTOS_D', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1088, 'FIREBASE_DEVICES', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1089, 'FORNECEDORES', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1090, 'HISTORICO_PAGAMENTO', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1091, 'IMAGENSPRD', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1092, 'LOG', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1093, 'LOGOMARCAS', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1094, 'PERMISSOES', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1095, 'PRODUTOS', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1096, 'RECEBER', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1097, 'USUARIOS', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1098, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1099, 'VENDAC', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1100, 'VENDAD', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1101, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1102, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1103, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1104, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1105, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1106, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1107, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1108, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1109, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1110, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1111, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1112, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1113, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1114, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1115, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1116, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1117, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1118, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1119, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1120, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1121, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1122, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1123, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1124, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1125, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1126, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1127, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1128, 'USUARIOS_LOGIN_TENTA', '81988029779', 'db13c31d4e764e0f', 'S', 'S', 'S', 'N', 'ADM'),
('03100188462', 1129, 'TABELAS', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1130, 'CATEGORIAS', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1131, 'CHAVE_DE_LICENCA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1132, 'CHEQUES', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1133, 'CIDADES', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1134, 'CLIENTES', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1135, 'CONF_PAGAMENTO', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1136, 'EMPRESA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1137, 'EMPRESA_CONFIG', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1138, 'ENTRADA_PRODUTOS', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1139, 'ENTRADA_PRODUTOS_D', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1140, 'FIREBASE_DEVICES', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1141, 'FORNECEDORES', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1142, 'HISTORICO_PAGAMENTO', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1143, 'IMAGENSPRD', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1144, 'LOG', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1145, 'LOGOMARCAS', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1146, 'PERMISSOES', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1147, 'PRODUTOS', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1148, 'RECEBER', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1149, 'USUARIOS', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1150, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1151, 'VENDAC', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1152, 'VENDAD', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1153, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1154, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1155, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1156, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1157, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1158, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1159, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1160, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1161, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1162, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1163, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1164, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1165, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1166, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1167, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1168, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1169, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1170, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1171, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1172, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1173, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1174, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1175, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1176, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1177, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1178, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1179, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1180, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1181, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1182, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1183, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1184, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1185, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER'),
('03100188462', 1186, 'USUARIOS_LOGIN_TENTA', '16991431147', '7ed06244a9e3797f', 'N', 'N', 'N', 'N', 'USER');
...
INSERT INTO `produtos` (`ID_CPF_EMPRESA`, `prd_codigo`, `prd_ativo`, `prd_EAN`, `prd_descricao`, `prd_descr_red`, `prd_custo`, `prd_preco`, `prd_unmed`, `prd_quant`, `prd_obs`, `for_codigo`, `cat_codigo`) VALUES
('03100188462', 77, 'S', '5616519819819', 'cerveja kaiser 600 ml', 'kaiser 600ml', '3.00', '4.00', 'LT', '-12.00', '', 1, 5),
('03100188462', 78, 'S', '0056987987215', 'cerveja cintra 600ml', 'cintra 600 ml', '2.00', '3.00', 'LT', '-67.00', '', 1, 5),
('03100188462', 79, 'S', '0000265465498', 'salgadinho chebeck 300g', 'chebeck 300g', '0.59', '1.50', 'G', '-56.00', '', 1, 3),
('03100188462', 80, 'S', '5598979862546', 'suco tampico 250ml', 'tampico 250ml', '5.00', '8.00', 'LT', '145.00', '', 1, 2),
('03100188462', 81, 'S', '0225500336699', 'coca cola lata', 'coca lata', '2.99', '4.00', 'LT', '-44.00', '', 1, 2),
('03100188462', 82, 'S', '5555698978978', 'pacoquinha moreninha do rio', 'moreninha do rio', '3.00', '5.50', 'UN', '3.00', '', 1, 2),
('03100188462', 83, 'S', '5865745258965', 'coca cola 2 litros', 'coca cola 2 litros', '3.99', '4.50', 'LT', '-11.00', '', 1, 2),
('03100188462', 84, 'S', '3256985484525', 'guarana jaboti 2l', 'guarana jaboti 2l', '3.99', '4.50', 'LT', '-44.00', '', 1, 2),
('03100188462', 85, 'S', '3695845258974', 'guarana it 350ml', 'guarana it 350ml', '3.99', '4.50', 'LT', '-66.00', '', 1, 2),
('03100188462', 86, 'S', '2359587412367', 'agua com gas', 'agua com gas', '3.99', '4.50', 'LT', '-11.00', '', 1, 2),
('03100188462', 87, 'S', '2365801202479', 'agua sem gas', 'agua sem gas', '6.00', '7.00', 'LT', '286.00', '', 1, 2),
('03100188462', 88, 'S', '2874102024896', 'fanta laranja 350ml', 'fanta laranja 350ml', '3.99', '4.50', 'LT', '-21.00', '', 1, 1),
('03100188462', 89, 'S', '3698745214047', 'coca cola lata 350ml', 'coca cola lata 350ml', '3.99', '4.50', 'LT', '-11.00', '', 1, 1),
('03100188462', 90, 'S', '3025874102563', 'suco nativo 600ml', 'suco nativo 600ml', '3.99', '4.50', 'LT', '0.00', '', 1, 1),
('03100188462', 91, 'S', '2585648589635', 'suco delice 350ml', 'suco delice 350ml', '3.99', '4.50', 'LT', '-11.00', '', 1, 1),
('03100188462', 92, 'S', '2021405068034', 'guarana maçã 600ml', 'guarana maçã 600ml', '3.99', '4.50', 'LT', '-9.00', '', 1, 1),
('03100188462', 93, 'S', '2015050528049', 'cerveja kaiser 600ml', 'cerveja kaiser 600ml', '3.99', '4.50', 'LT', '0.00', '', 1, 1),
('03100188462', 94, 'S', '3332221544896', 'cerveja ice 600ml', 'cerveja ice 600ml', '3.99', '4.50', 'LT', '0.00', '', 1, 1),
('03100188462', 95, 'S', '3698547853698', 'cerveja bhrama 600ml', 'cerveja bhrama 600ml', '3.99', '4.50', 'LT', '0.00', '', 1, 1),
('03100188462', 96, 'S', '3698535215698', 'cerveja skin 600ml', 'cerveja skin 600ml', '3.99', '4.50', 'LT', '0.00', '', 1, 1),
('03100188462', 97, 'S', '3636985851312', 'coca cola 1.5', 'coca cola 1.5', '3.99', '4.50', 'LT', '0.00', '', 1, 1),
('03100188462', 98, 'S', '3202145698120', 'guarana jaboti 600ml maçã', 'guarana jaboti 600ml maçã', '5.00', '4.50', 'LT', '0.00', '', 1, 1),
('03100188462', 99, 'S', '1234567890908', 'cocada amarela', 'cocada', '0.00', '0.00', 'UN', '0.00', 'doce', 2, 13),
('03100188462', 100, 'S', '7676543567876', 'biscoito pampers', 'bisc pamp', '0.00', '0.00', 'CX', '0.00', 'caixa com 30 unidades', 1, 1);
...
CREATE TABLE `receber` (
  ...
  `rec_num_parcela` int DEFAULT NULL,
  `rec_cli_codigo` int DEFAULT NULL,
  ...
  `rec_parcelas_cartao` int DEFAULT NULL,
...
INSERT INTO `receber` (`ID_CPF_EMPRESA`, `rec_codigo`, `rec_num_parcela`, `rec_cli_codigo`, `rec_cli_nome`, `vendac_chave`, `rec_datamovimento`, `rec_valorreceber`, `rec_datavencimento`, `rec_datavencimento_extenso`, `rec_data_que_pagou`, `rec_valor_pago`, `rec_recebeu_com`, `rec_parcelas_cartao`, `rec_enviado`) VALUES
('03100188462', 12, 1, 9, 'casas oliveiras ltda', '1020782', '2020-07-18', '16.50', '2020-07-18', 'sábado, 18 de julho de 2020', '2020-07-18', '16.50', 'dinheiro', 0, 'N'),
('03100188462', 13, 1, 9, 'casas oliveiras ltda', '8586673', '2020-07-18', '8.00', '2020-07-18', 'sábado, 18 de julho de 2020', '2020-07-18', '8.00', 'dinheiro', 0, 'N'),
('03100188462', 14, 1, 10, 'supranor ltda', '4475958', '2020-07-18', '6.00', '2020-07-18', 'sábado, 18 de julho de 2020', '2020-07-18', '6.00', 'dinheiro', 0, 'N'),
('03100188462', 15, 1, 10, 'supranor ltda', '3861402', '2020-07-18', '17.00', '2020-08-18', 'terça-feira, 18 de agosto de 2020', '2020-07-18', '17.00', 'dinheiro', 0, 'N'),
('03100188462', 16, 1, 9, 'casas oliveiras ltda', '4178816', '2020-07-18', '413.00', '2020-08-03', 'segunda-feira, 3 de agosto de 2020', '2020-07-18', '413.00', 'dinheiro', 0, 'N'),
('03100188462', 17, 1, 11, 'joao severino da silva', '3462501', '2020-07-18', '150.00', '2020-07-18', 'sábado, 18 de julho de 2020', '2020-07-18', '150.00', 'cartao', 2, 'N'),
('03100188462', 18, 2, 9, 'casas oliveiras ltda', '4178816', '2020-07-18', '413.00', '2020-08-18', 'terça-feira, 18 de agosto de 2020', '1980-09-14', '0.00', '', 0, 'N');
...
INSERT INTO `TABELAS` (`tabela_id`, `tabela_nome`) VALUES
(806, 'TABELAS'),
(807, 'CATEGORIAS'),
(808, 'CHAVE_DE_LICENCA'),
(809, 'CHEQUES'),
(810, 'CIDADES'),
(811, 'CLIENTES'),
(812, 'CONF_PAGAMENTO'),
(813, 'EMPRESA'),
(814, 'EMPRESA_CONFIG'),
(815, 'ENTRADA_PRODUTOS'),
(816, 'ENTRADA_PRODUTOS_D'),
(817, 'FIREBASE_DEVICES'),
(818, 'FORNECEDORES'),
(819, 'HISTORICO_PAGAMENTO'),
(820, 'IMAGENSPRD'),
(821, 'LOG'),
(822, 'LOGOMARCAS'),
(823, 'PERMISSOES'),
...
(825, 'RECEBER'),
(826, 'USUARIOS'),
(827, 'USUARIOS_LOGIN_TENTA'),
(828, 'VENDAC'),
(829, 'VENDAD'),
(830, 'USUARIOS_LOGIN_TENTA'),
(831, 'USUARIOS_LOGIN_TENTA'),
(832, 'USUARIOS_LOGIN_TENTA'),
(833, 'USUARIOS_LOGIN_TENTA'),
(834, 'USUARIOS_LOGIN_TENTA'),
(835, 'USUARIOS_LOGIN_TENTA'),
(836, 'USUARIOS_LOGIN_TENTA'),
(837, 'USUARIOS_LOGIN_TENTA'),
(838, 'USUARIOS_LOGIN_TENTA'),
(839, 'USUARIOS_LOGIN_TENTA'),
(840, 'USUARIOS_LOGIN_TENTA'),
(841, 'USUARIOS_LOGIN_TENTA'),
(842, 'USUARIOS_LOGIN_TENTA'),
(843, 'USUARIOS_LOGIN_TENTA'),
(844, 'USUARIOS_LOGIN_TENTA'),
(845, 'USUARIOS_LOGIN_TENTA'),
(846, 'USUARIOS_LOGIN_TENTA'),
(847, 'USUARIOS_LOGIN_TENTA'),
(848, 'USUARIOS_LOGIN_TENTA'),
(849, 'USUARIOS_LOGIN_TENTA'),
(850, 'USUARIOS_LOGIN_TENTA'),
(851, 'USUARIOS_LOGIN_TENTA'),
(852, 'USUARIOS_LOGIN_TENTA'),
(853, 'USUARIOS_LOGIN_TENTA'),
(854, 'USUARIOS_LOGIN_TENTA'),
(855, 'USUARIOS_LOGIN_TENTA'),
(856, 'USUARIOS_LOGIN_TENTA'),
(857, 'USUARIOS_LOGIN_TENTA'),
(858, 'USUARIOS_LOGIN_TENTA'),
(859, 'USUARIOS_LOGIN_TENTA'),
(860, 'USUARIOS_LOGIN_TENTA'),
(861, 'USUARIOS_LOGIN_TENTA'),
(862, 'USUARIOS_LOGIN_TENTA'),
(863, 'USUARIOS_LOGIN_TENTA'),
(864, 'USUARIOS_LOGIN_TENTA'),
(865, 'USUARIOS_LOGIN_TENTA'),
(866, 'USUARIOS_LOGIN_TENTA'),
(867, 'USUARIOS_LOGIN_TENTA'),
(868, 'USUARIOS_LOGIN_TENTA'),
(869, 'USUARIOS_LOGIN_TENTA'),
(870, 'USUARIOS_LOGIN_TENTA'),
(871, 'USUARIOS_LOGIN_TENTA'),
(872, 'USUARIOS_LOGIN_TENTA'),
(873, 'USUARIOS_LOGIN_TENTA'),
(874, 'USUARIOS_LOGIN_TENTA'),
(875, 'USUARIOS_LOGIN_TENTA'),
(876, 'USUARIOS_LOGIN_TENTA'),
(877, 'USUARIOS_LOGIN_TENTA'),
(878, 'USUARIOS_LOGIN_TENTA');
...
INSERT INTO `usuarios` (`ID_CPF_EMPRESA`, `usu_codigo`, `usu_nome`, `usu_email`, `usu_celularkey`, `usu_numerocelular`, `usu_cpf`, `usu_dispositivo`, `usu_liberado`, `usu_desconto`, `usu_comissao`) VALUES
('22124254812', 42, 'diretor', 'diretor@gmail.com', '3fxDIRETOR', '16993584313', '$2y$10$7roMzF18pEQfHeWCiTsZnutmP9XJfsXCtJ2xKt5r.PQQtidI0ldpa', 'MARCA_DO_SEU_CELULAR', 'S', '0', '0'),
('03100188462', 45, 'augusto', 'augustoall@gmail.com', 'db13c31d4e764e0f', '81988029779', '$2y$10$dBX2VdDoSolngwgC49T.ne00tmQQoVPgHyxgVUpcwuHZ9qNOos5Yq', 'MARCA_DO_SEU_CELULAR', 'S', '0', '0'),
('03100188462', 46, 'vendedor paulo', 'vendedor001@gmail.com', '7ed06244a9e3797f', '16991431147', '$2y$10$ONXM8jkBlpUTmTXRh2e2b.Gw.IutkMcvC2XRQ4sAo8ESk22LXuDGy', 'MARCA_DO_SEU_CELULAR', 'S', '0', '0');

-- --------------------------------------------------------

--
-- Estrutura para tabela `usuarios_login_tentativas`
--
...
CREATE TABLE `usuarios_login_tentativas` (
  ...
  `senha` varchar(300) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `origem` varchar(300) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
  `bloqueado` char(3) CHARACTER SET latin1 COLLATE latin1_general_ci DEFAULT NULL,
...
--
-- Despejando dados para a tabela `vendac`
--

INSERT INTO `vendac` (`vendac_id`, `ID_CPF_EMPRESA`, `vendac_chave`, `vendac_datahoravenda`, `vendac_previsao_entrega`, `vendac_usu_codigo`, `vendac_usu_nome`, `vendac_cli_codigo`, `vendac_cli_nome`, `vendac_fpgto_codigo`, `vendac_fpgto_tipo`, `vendac_valor`, `vendac_peso_total`, `vendac_observacao`, `vendac_enviada`, `vendac_latitude`, `vendac_longitude`) VALUES
(5, '22124254812', '8884385', '2020-07-17 15:43:00', '2020-07-28', 42, 'diretor', 1, 'gilberto gomes dos santos', 0, 'AVISTA 0 x', '72.00', '0.00', 'venda avista no cartao em 2x', 'N', '-18.9625561', '-48.3486507'),
(6, '03100188462', '1020782', '2020-07-18 13:12:00', '2020-07-18', 46, 'vendedor paulo', 9, 'casas oliveiras ltda', 0, 'AVISTA 0 x', '16.50', '0.00', '', 'N', '-18.9071337', '-48.2849746'),
(7, '03100188462', '8586673', '2020-07-18 11:39:00', '2020-07-18', 45, 'augusto', 9, 'casas oliveiras ltda', 0, 'AVISTA 0 x', '8.00', '0.00', '', 'N', '-7.9471134', '-35.0275595'),
(8, '03100188462', '4475958', '2020-07-18 16:08:00', '2020-07-18', 45, 'augusto', 10, 'supranor ltda', 0, 'AVISTA 0 x', '6.00', '0.00', '', 'N', '-7.9475353', '-35.0277785'),
(9, '03100188462', '3861402', '2020-07-18 18:44:00', '2020-07-18', 45, 'augusto', 10, 'supranor ltda', 0, 'MENSAL 1 x', '17.00', '0.00', '', 'N', '-7.9475213', '-35.0277826'),
(10, '03100188462', '3462501', '2020-07-18 21:08:00', '2020-07-18', 45, 'augusto', 11, 'joao severino da silva', 0, 'AVISTA 0 x', '150.00', '0.00', 'venda avista no cartao em 2x', 'N', '-7.9475415', '-35.0277794'),
(11, '03100188462', '4178816', '2020-07-18 21:13:00', '2020-07-14', 45, 'augusto', 9, 'casas oliveiras ltda', 0, 'QUINZENAL 2 x', '826.00', '0.00', '', 'N', '-7.9475454', '-35.0277811');

-- --------------------------------------------------------

--
-- Estrutura para tabela `vendad`
--

CREATE TABLE `vendad` (
  `ID_CPF_EMPRESA` varchar(11) DEFAULT NULL,
  `vendac_chave` varchar(70) DEFAULT NULL,
  `vendad_nro_item` int DEFAULT NULL,
  `vendad_ean` varchar(50) DEFAULT NULL,
  `vendad_codigo_produto` int DEFAULT NULL,
...
--
-- Despejando dados para a tabela `vendad`
--

INSERT INTO `vendad` (`ID_CPF_EMPRESA`, `vendac_chave`, `vendad_nro_item`, `vendad_ean`, `vendad_codigo_produto`, `vendad_descricao_produto`, `vendad_quantidade`, `vendad_precovenda`, `vendad_total`) VALUES
('22124254812', '8884385', 1, '5616519819819', 77, 'cerveja kaiser 600 ml', '10', '4.00', '40.00'),
('22124254812', '8884385', 2, '0000265465498', 79, 'salgadinho chebeck 300g', '3', '1.50', '4.50'),
('22124254812', '8884385', 3, '5555698978978', 82, 'pacoquinha moreninha do rio', '5', '5.50', '27.50'),
('03100188462', '1020782', 1, '5555698978978', 82, 'pacoquinha moreninha do rio', '3', '5.50', '16.50'),
('03100188462', '8586673', 1, '5616519819819', 77, 'cerveja kaiser 600 ml', '2', '4.00', '8.00'),
('03100188462', '4475958', 1, '0056987987215', 78, 'cerveja cintra 600ml', '2', '3.00', '6.00'),
('03100188462', '3861402', 1, '5616519819819', 77, 'cerveja kaiser 600 ml', '2', '4.00', '8.00'),
('03100188462', '3861402', 2, '0056987987215', 78, 'cerveja cintra 600ml', '3', '3.00', '9.00'),
('03100188462', '3462501', 1, '5598979862546', 80, 'suco tampico 250ml', '5', '8.00', '40.00'),
('03100188462', '3462501', 2, '5555698978978', 82, 'pacoquinha moreninha do rio', '20', '5.50', '110.00'),
('03100188462', '4178816', 1, '3256985484525', 84, 'guarana jaboti 2l', '28', '4.50', '126.00'),
('03100188462', '4178816', 2, '2365801202479', 87, 'agua sem gas', '100', '7.00', '700.00');
...
--
-- Índices de tabela `chave_de_licenca`
--
ALTER TABLE `chave_de_licenca`
...
--
ALTER TABLE `cheques`
  ADD PRIMARY KEY (`chq_codigo`),
  ADD KEY `fk_cliente` (`chq_cli_codigo`);
...
ALTER TABLE `clientes`
  ...
  ADD KEY `cli_chave` (`cli_chave`),
  ADD KEY `fk_usuario2_idx` (`usu_codigo`);

--
-- Índices de tabela `conf_pagamento`
--
ALTER TABLE `conf_pagamento`
...
ALTER TABLE `entrada_produtos`
  ...
  ADD KEY `fk_fornec` (`for_codigo`),
  ADD KEY `fk_vendedor1_idx` (`usu_codigo`);

--
-- Índices de tabela `entrada_produtos_d`
--
ALTER TABLE `entrada_produtos_d`
  ADD KEY `fk_produto` (`entd_prd_codigo`);

--
-- Índices de tabela `firebase_devices`
--
ALTER TABLE `firebase_devices`
  ADD PRIMARY KEY (`id`);
...
--
-- Índices de tabela `imagensprd`
--
ALTER TABLE `imagensprd`
  ADD PRIMARY KEY (`img_codigo`),
  ADD KEY `fk_produtoimg` (`prd_codigo`);
...
--
-- Índices de tabela `logomarcas`
--
ALTER TABLE `logomarcas`
  ADD PRIMARY KEY (`lgm_codigo`);
...
ALTER TABLE `produtos`
  ...
  ADD KEY `fk_fornecedores` (`for_codigo`);
...
ALTER TABLE `receber`
  ...
  ADD KEY `fk_cliente_rec` (`rec_cli_codigo`);
...
--
-- Índices de tabela `usuarios_login_tentativas`
--
ALTER TABLE `usuarios_login_tentativas`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `vendac`
--
ALTER TABLE `vendac`
  ADD PRIMARY KEY (`vendac_id`),
  ADD KEY `fk_clientes_vendac` (`vendac_cli_codigo`),
  ADD KEY `fk_vendedor_vendac` (`vendac_usu_codigo`);

--
-- Índices de tabela `vendad`
--
ALTER TABLE `vendad`
  ADD KEY `fk_produto_vendad` (`vendad_codigo_produto`);
...
--
ALTER TABLE `categorias`
  MODIFY `cat_codigo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de tabela `chave_de_licenca`
--
ALTER TABLE `chave_de_licenca`
  MODIFY `lic_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de tabela `cheques`
--
ALTER TABLE `cheques`
  MODIFY `chq_codigo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `clientes`
--
ALTER TABLE `clientes`
  MODIFY `cli_codigo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de tabela `conf_pagamento`
--
ALTER TABLE `conf_pagamento`
  MODIFY `pag_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de tabela `empresa`
--
ALTER TABLE `empresa`
  MODIFY `emp_codigo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `entrada_produtos`
  MODIFY `ent_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de tabela `firebase_devices`
--
ALTER TABLE `firebase_devices`
...
--
ALTER TABLE `fornecedores`
  MODIFY `for_codigo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `historico_pagamento`
--
ALTER TABLE `historico_pagamento`
  MODIFY `hist_codigo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT de tabela `imagensprd`
--
ALTER TABLE `imagensprd`
  MODIFY `img_codigo` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `log`
--
ALTER TABLE `log`
  MODIFY `log_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=268;

--
-- AUTO_INCREMENT de tabela `logomarcas`
--
ALTER TABLE `logomarcas`
  MODIFY `lgm_codigo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `permissoes`
--
ALTER TABLE `permissoes`
  MODIFY `per_codigo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1187;

--
-- AUTO_INCREMENT de tabela `produtos`
--
ALTER TABLE `produtos`
  MODIFY `prd_codigo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;

--
-- AUTO_INCREMENT de tabela `receber`
--
ALTER TABLE `receber`
  MODIFY `rec_codigo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT de tabela `TABELAS`
--
ALTER TABLE `TABELAS`
  MODIFY `tabela_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=879;

--
-- AUTO_INCREMENT de tabela `usuarios`
--
ALTER TABLE `usuarios`
  MODIFY `usu_codigo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT de tabela `usuarios_login_tentativas`
--
ALTER TABLE `usuarios_login_tentativas`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `vendac`
--
ALTER TABLE `vendac`
  MODIFY `vendac_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `cheques`
  ADD CONSTRAINT `fk_cliente` FOREIGN KEY (`chq_cli_codigo`) REFERENCES `clientes` (`cli_codigo`);

--
-- Restrições para tabelas `entrada_produtos`
--
ALTER TABLE `entrada_produtos`
  ADD CONSTRAINT `fk_fornec` FOREIGN KEY (`for_codigo`) REFERENCES `fornecedores` (`for_codigo`),
  ADD CONSTRAINT `fk_vendedor1` FOREIGN KEY (`usu_codigo`) REFERENCES `usuarios` (`usu_codigo`);

--
-- Restrições para tabelas `entrada_produtos_d`
--
ALTER TABLE `entrada_produtos_d`
  ADD CONSTRAINT `fk_produto` FOREIGN KEY (`entd_prd_codigo`) REFERENCES `produtos` (`prd_codigo`);

--
-- Restrições para tabelas `imagensprd`
--
ALTER TABLE `imagensprd`
  ADD CONSTRAINT `fk_produtoimg` FOREIGN KEY (`prd_codigo`) REFERENCES `produtos` (`prd_codigo`);

--
-- Restrições para tabelas `produtos`
--
ALTER TABLE `produtos`
  ADD CONSTRAINT `fk_categorias` FOREIGN KEY (`cat_codigo`) REFERENCES `categorias` (`cat_codigo`),
  ADD CONSTRAINT `fk_fornecedores` FOREIGN KEY (`for_codigo`) REFERENCES `fornecedores` (`for_codigo`);

--
-- Restrições para tabelas `receber`
--
ALTER TABLE `receber`
  ADD CONSTRAINT `fk_cliente_rec` FOREIGN KEY (`rec_cli_codigo`) REFERENCES `clientes` (`cli_codigo`);

--
-- Restrições para tabelas `vendac`
--
ALTER TABLE `vendac`
  ADD CONSTRAINT `fk_clientes_vendac` FOREIGN KEY (`vendac_cli_codigo`) REFERENCES `clientes` (`cli_codigo`),
  ADD CONSTRAINT `fk_vendedor_vendac` FOREIGN KEY (`vendac_usu_codigo`) REFERENCES `usuarios` (`usu_codigo`);

--
-- Restrições para tabelas `vendad`
--
ALTER TABLE `vendad`
  ADD CONSTRAINT `fk_produto_vendad` FOREIGN KEY (`vendad_codigo_produto`) REFERENCES `produtos` (`prd_codigo`);
COMMIT;
