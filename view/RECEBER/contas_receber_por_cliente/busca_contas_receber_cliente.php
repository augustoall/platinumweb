                ...
                <div class="col-md-12 col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Imprimir contas a receber por cliente </h3>
                        </div> 

                        <form role="form" class="form-group" name="form"  method="post"  autocomplete="off" action="relatorio_contas_receber_cliente.php">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-12">                                    
                                    <div class="form-group">                       
                                        <input type="radio" checked id="radio1" value="TODAS" name="filtrar_conta" /><label for="radio1">Imprimir todas as contas</label>
                                        <input type="radio" id="radio2" value="PAGAS" name="filtrar_conta"/><label for="radio2">Imprimir contas pagas</label> 
                                        <input type="radio" id="radio3" value="ABERTO" name="filtrar_conta"/><label for="radio3">Imprimir contas em aberto</label> 
                                    </div>
                                </div>
