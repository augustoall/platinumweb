                ...
                <div class="col-md-12 col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Imprimir vendas por clientes </h3>
                        </div> 


                        <form role="form" class="form-group" name="form"  method="post"  autocomplete="off" action="relatorio_vendas_por_cliente.php">
