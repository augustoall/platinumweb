...
$clienteBean = $cliente->c_buscaClientePorNome($_SESSION["ID_CPF_EMPRESA"], trim($cli_nome));
...
$vendaCBean = $vendaC->c_busca_vendac_por_cli_codigo_e_data_between($_SESSION["ID_CPF_EMPRESA"], $clienteBean->getCli_codigo(), $data_inicial, $data_final);
