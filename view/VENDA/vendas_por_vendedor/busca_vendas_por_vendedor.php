...
<html lang="pt-br">
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                ...
                <div class="col-md-12 col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Imprimir vendas por vendedor </h3>
                        </div> 


                        <form role="form" class="form-group" name="form"  method="post"  autocomplete="off" action="relatorio_vendas_por_vendedor.php">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-sm-3"> 
                                    <div class="form-group">
                                        <input class="minimal" type="checkbox" name="IMPRIME_ITENS"  checked /> Imprimir itens da venda
                                    </div> 
                                </div> 
        ...
        <!-- autocomplete -->
        <script src="auto_complete_vendedor.js?v2"></script>
        <!-- AdminLTE App -->
