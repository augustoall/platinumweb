...
$permissaoBean = $permisao->C_buscarPermParaTabelaDe("cheques");
                                ...
                                <div class="dataTable_wrapper">  
                                    <table class="table table-condensed table-bordered table-hover" id="tabela">
                                        ...
                                        <tbody>                                          
                                            ...
                                            $chequeBean = $cheque->c_busca_todos_cheques($ID_CPF_EMPRESA);
                                            $count = count($chequeBean);
                                            foreach ($chequeBean as $che) {
                                                ?>
                                                <tr class="gradeA odd" role="row">
                                                    <td class="listagem_vendas"><?php echo $che->getChq_numerocheque() ?></td>
                                                    <td class="listagem_vendas"><?php echo $che->getVendac_chave() ?></td>
                                                    <td class="listagem_vendas"><?php echo $che->getChq_valorcheque() ?></td>
                                                    <td class="listagem_vendas"><?php echo strtoupper($che->getCli_nome()) ?></td>
                                                    <td class="listagem_vendas"><?php echo strtoupper($che->getChq_nomebanco()) ?></td>
                                                    <td class="listagem_vendas"><?php echo $che->getChq_telefone1() . ' - ' . $che->getChq_telefone2() ?></td>
                                                    <td class="listagem_vendas"><?php echo strtoupper($che->getChq_nomedono()) ?></td>
                                                    <td class="listagem_vendas"><?php echo $che->getChq_vencimento() ?></td>  
                                                </tr>
                                                <?php
                                            }
                                            ?>
