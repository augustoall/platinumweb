...
if ($codigo > 0) {
    ...
    $entrada = $entradaproduto->c_buscar_entradaproduto_porcodigo($codigo, $ID_CPF_EMPRESA);
}
?>
<!DOCTYPE html>
<html lang="pt-br">
                ...
                <div class="col-md-12 col-xs-12">
                    <div class="box box-primary">
                        ...
                        <form method="post" name="frm_entradaprodutos" id="frm_entradaprodutos">                       
                            ...
                            <input type="hidden" name="usu_codigo" value="<?php echo $entrada['usu_codigo'] ?>" />
                            <input type="hidden" name="ent_data_entrada" value="<?php echo $entrada['ent_data_entrada'] ?>" />

                            <?php if ($alterar == "S"): ?>
                                <div class="box-footer"> 
                                    <button type="submit" class="btn btn-warning btn-xs"><i class="fa fa-floppy-o" aria-hidden="true"></i> Alterar Nota de Entrada</button>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-2 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" readonly value="<?php echo $entrada['ent_id'] ?>" name="ent_id" id="ent_id" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-5 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" readonly value="<?php echo $entrada['usu_codigo'] ?>" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-5 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" readonly value="<?php echo $entrada['ent_data_entrada'] ?>" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" maxlength="15" type="text" required value="<?php echo $entrada['ent_numeronota'] ?>" name="ent_numeronota" id="ent_numeronota" />
                                    </div>
                                </div>                          
                                ...
                                <div class="col-md-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" required value="<?php echo $entrada['ent_valor_nota'] ?>" name="ent_valor_nota" id="ent_valor_nota" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select   class="form-control select2" id="for_codigo" name="for_codigo">  
                                        ...
                                        foreach ($fornBean as $p) {
                                            ?>
                                            <option   <?php echo ($p->getFor_codigo() == $entrada['for_codigo']) ? 'selected' : '' ?>  value="<?php echo $p->getFor_codigo() ?>"><?php echo $p->getFor_fantasia() ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
